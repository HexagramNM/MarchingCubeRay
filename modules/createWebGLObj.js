...
export function create_ibo(data) {
	...
	g_gl.bufferData(g_gl.ELEMENT_ARRAY_BUFFER, new Uint16Array(data), g_gl.STATIC_DRAW);
...
export function create_texture(source, number) {
	...
	img.onload = function() {
		...
		g_gl.texParameteri(g_gl.TEXTURE_2D, g_gl.TEXTURE_MIN_FILTER, g_gl.LINEAR_MIPMAP_LINEAR);
